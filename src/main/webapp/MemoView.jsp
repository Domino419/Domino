...
<title>메모 게시판에서는 클릭하면 내용확인 & 글 수정 기능으로 구현해놓아서 해당 페이지는 미사용  </title>
</head>
<body>
        ...
        <div class="row">
            ...
            <%
               // if(userID != null && userID.equals(bbs.getUserID()))  // 여기서 걸리나..?
                {
            %>
                <a href="MemoUpdate.jsp?bbsID=<%=(Integer.parseInt(request.getParameter("memoid")))%>" class="btn btn-primary">수정</a>
                <a href="MemoDeleteAction.jsp?bbsID=<%=(Integer.parseInt(request.getParameter("memoid")))%>" class="btn btn-primary">삭제</a>
