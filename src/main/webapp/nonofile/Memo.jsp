        ...
        <div class="row">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                ...
                <tbody>  
                    ...
                    <tr>
                        <%-- <td><%=list.get(i).getMemoid() %></td>
                        <td><a href="Memo.jsp?memoid=<%=list.get(i).getMemoid()%>"><%=list.get(i).getMemoid() %></a></td>
                        <td><%=list.get(i).getUserID() %></td>
                        <td><%=list.get(i).getData() %></td> --%>
                        <td><%=list.get(i).getData() %></td>
                        <td><%=list.get(i).getMemoid() %></td>
                        <td><%=list.get(i).getWorkcoment() %></td>
						<td><%=list.get(i).getComent() %></td>                                                
